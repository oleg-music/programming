...
/**
 * Класс DOMReader предоставляет функциональность для чтения XML-документов
 * с использованием DOM (Document Object Model).
 * Этот класс позволяет парсить XML-файлы и извлекать данные в виде объектов Java.
 */
public class DOMReader {
    ...
    /**
     * Вспомогательный метод для извлечения значения элемента из XML.
     * Поддерживает вложенные элементы через путь с "/".
     *
     * @param element Родительский элемент.
     * @param tagPath Путь к тегу, например, "coordinates/x".
     * @return Значение тега или null, если тег не найден.
     */
